const DMCAMD = `
**Copyright is an important topic for the Jseedav community. This Jseedav Copyright Policy is a part of Jseedav’s Terms of Service and sets forth the process by which copyright holders and their agents may remove allegedly infringing materials available on one of Jseedav’s online services. Below, you can find out how to manage your rights on Jseedav and learn more about respecting the rights of others.**

1. 1 DMCA Policy

**Jseedav respects the intellectual property of others and expects its users to do the same. Each user must ensure that the materials they upload do not infringe any third-party copyright. Jseedav will promptly remove materials in accordance with the Digital Millennium Copyright Act (“DMCA”) when properly notified that the materials infringe a third party's copyright. Jseedav will also, in appropriate circumstances, terminate the accounts of repeat copyright infringers.In filing any request, please ensure that your notice is complete and that your statements are accurate. If we request additional information necessary to make your notice complete, please provide that information promptly. If you fail to provide the required information, your request may not be processed further. For non-copyright complaints, please see our Trademark Infringement Complaint Form or our Privacy Complaint Form.**

2. 2 DMCA Takedown Notices
...
3. 3 DMCA Counter-Notifications
...
**Jseedav will terminate user accounts that receive three (3) DMCA strikes. A “DMCA strike” accrues each time that material is removed from a user’s account due to a DMCA notice. We may group multiple DMCA notices received within a short period of time as a single DMCA strike. We may remove a DMCA strike in appropriate circumstances, such as where (1) the underlying material is ultimately restored due to a DMCA counter-notification; or (2) the claimant withdraws the underlying notice. We may terminate user accounts that receive fewer than three (3) DMCA strikes in appropriate circumstances, such as where the user has a history of violating or willfully disregarding our Terms of Service.**
